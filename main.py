...
API_TOKEN = "1933370447:AAHUbiq_7vO4Vys9d5zLlTzaWJ9v8pHBkKw"
...
def start(message):
    ...
    if message.text == "Регистрация":
        ...
        remove_initial_keyboard(user_id, "Введите задачу")
...
def get_todo(message):
    ...
    user_id = message.from_user.id
    todo[user_id]["todo"] = todo_text.capitalize()
...
def render_initial_keyboard(user_id: int):
    ...
    login_button = types.KeyboardButton("todo")
